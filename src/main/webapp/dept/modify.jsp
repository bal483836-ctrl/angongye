...
<body>
<h1>修改部门信息</h1>
<form action="/dept/doModify.do" method="post">
    ...
    <table id = "deptEditTable">
        <tr>
            ...
            <td>
                <input type = "text" name="deptNo" id="deptNo" value="${dept.deptNo}"/>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type = "text" name="deptPid" id="deptPid"  value="${dept.deptPid}"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type = "text" name="deptAddress" id="deptAddress"  value="${dept.deptAddress}"/>
            </td>
        </tr>
